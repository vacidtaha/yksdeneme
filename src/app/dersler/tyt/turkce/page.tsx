...
export default function TytTurkcePage() {
  ...
  const topics: Topic[] = [
    {
      id: "sozcukte-anlam",
      title: "1. Sözcükte Anlam",
      color: "#007AFF",
      subTopics: [
        { id: "sozcugun-anlami", title: "Sözcüğün anlamı", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cok-anlamlilik", title: "Sözcükte çok anlamlılık", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "anlam-iliskileri", title: "Sözcükte anlam ilişkileri (eş, zıt, yakın, genel–özel vb.)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "deyim-atasozu", title: "Deyim ve atasözlerinde anlam", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "mecaz-anlam", title: "Mecaz, somut–soyut, gerçek–yan anlam", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "cumlede-anlam",
      title: "2. Cümlede Anlam",
      color: "#34C759",
      subTopics: [
        { id: "cumlede-anlam-iliskileri", title: "Cümlede anlam ilişkileri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "anlam-yonu", title: "Cümlede anlam yönü (olumlu–olumsuz)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cumle-tamamlama", title: "Cümle tamamlama", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cumle-olusturma", title: "Cümle oluşturma", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "anlami-bozan-cumle", title: "Anlamı bozan cümle", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "karsilastirma-neden-sonuc", title: "Cümlelerde karşılaştırma, neden–sonuç, amaç–sonuç", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kosul-oznel-nesnel", title: "Koşul, öznel–nesnel, varsayım, abartı vb.", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "paragrafta-anlam",
      title: "3. Paragrafta Anlam",
      color: "#FF9F0A",
      subTopics: [
        { id: "ana-yardimci-dusunce", title: "Ana düşünce / yardımcı düşünce", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "paragraf-yapisi", title: "Paragrafta yapı (giriş, gelişme, sonuç)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "paragraf-anlam-iliskileri", title: "Paragrafta anlam ilişkileri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "paragraf-tamamlama", title: "Paragraf tamamlama", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "paragraf-siralama", title: "Paragraf sıralama", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "anlatim-bicimi", title: "Paragrafta anlatım biçimi ve düşünceyi geliştirme yolları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "paragraf-yorumlama", title: "Paragraf yorumlama ve çıkarım yapma", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "ses-bilgisi",
      ...
      color: "#AF52DE",
      subTopics: [
        { id: "ses-olaylari", title: "Ses olayları (ünsüz benzeşmesi, ünlü düşmesi vb.)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "unlu-unsuz-uyumu", title: "Ünlü–ünsüz uyumu", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "yazimda-ses-olaylari", title: "Yazımda ses olaylarının etkisi", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "yazim-kurallari",
      title: "5. Yazım Kuralları (İmla)",
      color: "#FF3B30",
      subTopics: [
        { id: "buyuk-harf", title: "Büyük harf kullanımı", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "bitisik-ayri-yazim", title: "Bitişik/ayrı yazılan kelimeler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "baglaclar", title: "Bağlaçlar (de/da, ki)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "sayilarin-yazimi", title: "Sayıların yazımı", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kisaltmalar", title: "Kısaltmalar", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "noktalama",
      ...
      color: "#30D158",
      subTopics: [
        { id: "temel-noktalama", title: "Nokta, virgül, iki nokta, üç nokta vb.", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "unlem-soru", title: "Ünlem, soru işareti", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "tirnak-yay-cizgi", title: "Tırnak işareti, yay ayraç, kısa çizgi vb.", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "dil-bilgisi",
      title: "7. Dil Bilgisi (Dil Bilgisi ve Yapı Bilgisi)",
      color: "#0A84FF",
      subTopics: [
        { id: "sozcuk-turleri", title: "a) Sözcük Türleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "fiil-bilgisi", title: "b) Fiil Bilgisi", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "fiilimsiler", title: "c) Fiilimsiler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cumle-bilgisi", title: "d) Cümle Bilgisi", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "anlatim-bozukluklari",
      title: "8. Anlatım Bozuklukları",
      color: "#FF6482",
      subTopics: [
        { id: "yapisal-bozukluklar", title: "Yapısal bozukluklar", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "anlam-bozukluklari", title: "Anlam bozuklukları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "gereksiz-sozcuk", title: "Gereksiz sözcük kullanımı", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ozne-yuklem-uyumsuzlugu", title: "Özne–yüklem uyuşmazlığı", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "anlatim-turleri",
      title: "9. Anlatım Türleri ve Düşünceyi Geliştirme Yolları",
      color: "#64D2FF",
      subTopics: [
        { id: "anlatim-turleri-detay", title: "Açıklayıcı, tartışmacı, betimleyici, öyküleyici anlatım", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dusunce-gelistirme", title: "Tanık gösterme, örneklendirme, karşılaştırma, sayısal veriler, benzetme", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "metin-turleri",
      title: "10. Metin Türleri (Genel Kültür / Okuma Anlama)",
      color: "#BF5AF2",
      subTopics: [
        { id: "edebi-turler", title: "Hikâye, roman, şiir, tiyatro, makale, deneme, sohbet, fıkra, röportaj", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "diger-turler", title: "Haber metinleri, biyografi, otobiyografi, eleştiri", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    }
  ];
  ...
  // Progress tracking
  useEffect(() => {
    const saved = localStorage.getItem('tyt-turkce-completed');
    if (saved) {
  ...
  useEffect(() => {
    if (completedTopics.length > 0) {
      localStorage.setItem('tyt-turkce-completed', JSON.stringify(completedTopics));
    }
  }, [completedTopics]);
