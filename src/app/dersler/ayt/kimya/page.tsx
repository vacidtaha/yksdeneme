              ...
              <div className="sticky top-40 w-full max-w-4xl">
                {selectedTopic ? (
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { title: "Temel Kavramlar", duration: "20:15", views: "3.5K", instructor: "Prof. Dr. Mehmet Kaya" },
                        { title: "Detaylı Anlatım", duration: "28:40", views: "2.9K", instructor: "Öğr. Gör. Sema Aydın" },
                        { title: "Soru Çözümleri", duration: "24:55", views: "2.3K", instructor: "Dr. Kemal Özgür" },
                        { title: "Laboratuvar Uygulamaları", duration: "26:20", views: "1.9K", instructor: "Öğr. Gör. Aylin Çelik" }
                      ].map((video, i) => (
                        <div 
                          key={i}
