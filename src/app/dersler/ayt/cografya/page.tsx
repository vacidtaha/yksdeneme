...
export default function AytCografyaPage() {
  ...
  // AYT Coğrafya Konu Başlıkları
  const topics: Topic[] = [
    {
      id: "dogal-sistemler",
      title: "1. Doğal Sistemler",
      color: "#007AFF",
      subTopics: [
        { id: "yer-sekilleri", title: "Türkiye'nin Yer Şekilleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "iklim", title: "Türkiye'nin İklimi", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "su-varliklari", title: "Türkiye'nin Su Varlıkları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "toprak-bitki", title: "Türkiye'nin Toprak ve Bitki Örtüsü", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "dogal-afetler", title: "Doğal Afetler (Deprem, Heyelan, Sel vb.)", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "beseri-sistemler",
      title: "2. Beşeri Sistemler",
      color: "#34C759",
      subTopics: [
        { id: "nufus-yerlesme", title: "Nüfus ve Yerleşme (Türkiye'de Nüfus Özellikleri, Dağılımı ve Göçler)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "yerlesme-tipleri", title: "Türkiye'de Yerleşme Tipleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kir-kent", title: "Kır ve Kent Yerleşmeleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kirsal-nufus", title: "Kırsal Nüfusun Özellikleri", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "ekonomik-faaliyetler",
      title: "3. Ekonomik Faaliyetler",
      color: "#FF9F0A",
      subTopics: [
        { id: "tarim-hayvancilik", title: "Tarım, Hayvancılık ve Ormancılık", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "sanayi-endustri", title: "Türkiye'de Sanayi ve Endüstri Bölgeleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "madencilik-enerji", title: "Madencilik ve Enerji Kaynakları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ulasim-sistemleri", title: "Ulaşım Sistemleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ticaret-turizm", title: "Ticaret, Turizm ve Hizmet Sektörü", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ekonomik-dagilis", title: "Türkiye'de Ekonomik Faaliyetlerin Dağılışı", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "doga-insan",
      title: "4. Doğa ve İnsan Etkileşimi",
      color: "#AF52DE",
      subTopics: [
        { id: "dogal-kaynaklar", title: "Doğal Kaynakların Kullanımı ve Çevre Sorunları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "cevre-yonetimi", title: "Çevre Yönetimi ve Sürdürülebilirlik", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "afet-yonetimi", title: "Afet Yönetimi", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "bolgesel-cografya",
      title: "5. Bölgesel Coğrafya",
      color: "#FF2D92",
      subTopics: [
        { id: "cografi-bolgeler", title: "Türkiye'nin Coğrafi Bölgeleri", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "gelismislik-farkliliklari", title: "Bölgesel Gelişmişlik Farklılıkları", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kalkinma-projeleri", title: "Kalkınma Projeleri (GAP, DAP, KOP, ZBK vb.)", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "bolge-planlamasi", title: "Türkiye'de Bölge Planlaması", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    },
    {
      id: "kuresel-ortam",
      title: "6. Küresel Ortam: Bölgeler ve Ülkeler",
      color: "#5AC8FA",
      subTopics: [
        { id: "ulke-karsilastirmalari", title: "Dünya'dan Seçilen Ülkelerle Türkiye'nin Karşılaştırılması", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "ulkeler-arasi-iliskiler", title: "Ülkeler Arası Ekonomik ve Kültürel İlişkiler", hasVideo: true, hasPDF: true, hasQuiz: true },
        { id: "kuresel-sorunlar", title: "Küresel Sorunlar (İklim Değişikliği, Göç, Açlık, Savaş vb.)", hasVideo: true, hasPDF: true, hasQuiz: true }
      ]
    }
  ];
              ...
              <div className="sticky top-40 w-full max-w-4xl">
                {selectedTopic ? (
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { title: "Temel Kavramlar", duration: "20:15", views: "4.1K", instructor: "Prof. Dr. Ahmet Coğrafyacı" },
                        { title: "Detaylı Anlatım", duration: "28:30", views: "3.2K", instructor: "Öğr. Gör. Zeynep Harita" },
                        { title: "Soru Çözümleri", duration: "24:45", views: "2.7K", instructor: "Dr. Mehmet Dünya" },
                        { title: "Pratik Uygulamalar", duration: "26:20", views: "2.1K", instructor: "Öğr. Gör. Elif Atlas" }
                      ].map((video, i) => (
                        <div 
                          key={i}
