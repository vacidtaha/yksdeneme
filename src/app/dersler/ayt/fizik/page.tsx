              ...
              <div className="sticky top-40 w-full max-w-4xl">
                {selectedTopic ? (
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { title: "Temel Kavramlar", duration: "16:45", views: "2.8K", instructor: "Prof. Dr. Ahmet Yılmaz" },
                        { title: "Detaylı Örnekler", duration: "24:30", views: "2.1K", instructor: "Öğr. Gör. Merve Kaya" },
                        { title: "Soru Çözümleri", duration: "19:20", views: "1.7K", instructor: "Dr. Emre Demir" },
                        { title: "Pratik Uygulamalar", duration: "21:15", views: "1.4K", instructor: "Öğr. Gör. Cansu Öz" }
                      ].map((video, i) => (
                        <div 
                          key={i}
