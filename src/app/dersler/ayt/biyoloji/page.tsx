              ...
              <div className="sticky top-40 w-full max-w-4xl">
                {selectedTopic ? (
                  <div>
                    ...
                    <div className="space-y-4">
                      {[
                        { title: "Temel Kavramlar", duration: "18:25", views: "3.2K", instructor: "Prof. Dr. Leyla Özkan" },
                        { title: "Detaylı Anlatım", duration: "26:45", views: "2.6K", instructor: "Öğr. Gör. Burak Yıldız" },
                        { title: "Soru Çözümleri", duration: "22:10", views: "2.1K", instructor: "Dr. Elif Arslan" },
                        { title: "Pratik Uygulamalar", duration: "24:30", views: "1.8K", instructor: "Öğr. Gör. Deniz Akar" }
                      ].map((video, i) => (
                        <div 
                          key={i}
